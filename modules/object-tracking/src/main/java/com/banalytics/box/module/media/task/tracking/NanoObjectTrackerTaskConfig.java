...
@Getter
@Setter
public class NanoObjectTrackerTaskConfig extends AbstractObjectTrackerTaskConfig {
    @UIComponent(
            index = 20,
            type = drop_down,
            required = true,
            ...
            backendConfig = {
                    @UIComponent.BackendConfig(bean = "taskService", method = "subModelsList", params = {"nanotrack"})
            },
