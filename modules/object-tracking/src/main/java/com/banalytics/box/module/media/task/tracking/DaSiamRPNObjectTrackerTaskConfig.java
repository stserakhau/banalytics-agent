...
@Getter
@Setter
public class DaSiamRPNObjectTrackerTaskConfig extends AbstractObjectTrackerTaskConfig {
    ...
    @UIComponent(
            ...
            backendConfig = {
                    @UIComponent.BackendConfig(bean = "taskService", method = "subModelsList", params = {"dasiamrpn"})
            },
